...
type ChatOptions struct {
	...
	// OpenAI: **o-series models only** Constrains effort on reasoning for [reasoning models](https://platform.openai.com/docs/guides/reasoning).
	// Ollama: Think controls whether thinking/reasoning models will think before responding.
